...
export default function LoginPage() {
  ...
  const handleGoogleLogin = async () => {
    ...
    try {
      ...
      // Intentionally not setting false here if success because page will redirect
    ...
    <FabricCard className="p-[40px_48px] flex flex-col items-center w-full">
      ...
      <div className="w-full flex flex-col gap-4">
        ...
        <div className="flex items-center gap-3 w-full py-2">
          ...
          <span className="font-[family-name:var(--font-sans)] text-[11px] uppercase tracking-widest text-[var(--ink-faint)]">or</span>
          <hr className="flex-1 border-none border-t border-[var(--stitch)]" />
        </div>
