    ...
    >
      ...
      {showText && (
        <div className="absolute top-1/4 left-1/2 transform -translate-x-1/2 text-center w-full pointer-events-none px-4">
          <h2 className="text-white text-[32px] md:text-[52px] font-light mb-4" style={{ fontFamily: '"Cormorant Garamond", serif', textShadow: '0 4px 10px rgba(0,0,0,0.8)' }}>
            Your customer. Any fabric. Instantly.
          </h2>
          <p className="text-white/80 text-[16px] drop-shadow-lg mb-8" style={{ fontFamily: '"DM Sans", sans-serif' }}>
            FitLook AI generates a photorealistic preview in seconds.
          </p>
          <div className="pointer-events-auto flex justify-center">
            <Link href="/auth/signup">
              <button className="flex items-center gap-3 bg-[#C9A84C] hover:bg-[#B3933C] text-black px-8 py-4 rounded-full font-medium tracking-wide transition-all shadow-[0_0_20px_rgba(201,168,76,0.3)] hover:shadow-[0_0_30px_rgba(201,168,76,0.5)] cursor-pointer">
      ...
      {progress >= 0.60 && progress < 0.80 && (
        <div className="absolute top-24 left-1/2 transform -translate-x-1/2 text-center w-full pointer-events-none">
          <p className="text-white text-[24px] font-light drop-shadow-md" style={{ fontFamily: '"Cormorant Garamond", serif' }}>
