  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="w-full h-full rounded-sm overflow-hidden shadow-[0_0_50px_rgba(0,0,0,0.5)] relative bg-[#0F0A06]">
          <video
            src="/hero_video_v3.mp4"
            autoPlay
            loop
            muted
            playsInline
          ...
          />
          {/* Subtle overlay to enhance text contrast and blend edges */}
